...
WebUI.click(findTestObject('Admin/Manage_Usr/viewUsrModal/editUsr/div__outOfModal'))

WebUI.verifyElementNotVisible(findTestObject('Admin/Manage_Usr/viewUsrModal/editUsr/div_editUsrModal'))
