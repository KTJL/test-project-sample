...
if (WebUI.verifyElementPresent(findTestObject('Reviewer/ReviewPage/textarea_reason'), 5) == false) {
	WebUI.click(findTestObject('Reviewer/ReviewPage/div_checkbox'))
}

WebUI.setText(findTestObject('Reviewer/ReviewPage/textarea__reason'), 'good!')

WebUI.click(findTestObject('Reviewer/ReviewPage/div_checkbox'))

WebUI.click(findTestObject('Reviewer/ReviewPage/button_saveReview'))

WebUI.refresh()

WebUI.click(findTestObject('Reviewer/ReviewPage/button_Applicant_test02'))

WebUI.verifyElementNotPresent(findTestObject('Reviewer/ReviewPage/textarea_reason'), 5)
