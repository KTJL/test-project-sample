...
WebUI.click(findTestObject('ProgramManager/HomePage/svg_unstartedbut'))

WebUI.verifyElementPresent(findTestObject('ProgramManager/HomePage/div_unstartedlist'), 0)

WebUI.click(findTestObject('ProgramManager/HomePage/svg_unstartedbut'))

WebUI.verifyElementNotPresent(findTestObject('ProgramManager/HomePage/div_unstartedlist'), 0)

WebUI.click(findTestObject('ProgramManager/HomePage/svg_inprogressbut'))

WebUI.verifyElementPresent(findTestObject('ProgramManager/HomePage/div__inprogresslist'), 0)

WebUI.click(findTestObject('ProgramManager/HomePage/svg_inprogressbut'))

WebUI.verifyElementNotPresent(findTestObject('ProgramManager/HomePage/div__inprogresslist'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('ProgramManager/HomePage/svg_endedbut'))
