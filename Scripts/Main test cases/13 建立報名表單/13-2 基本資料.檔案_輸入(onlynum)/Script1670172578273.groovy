...
WebUI.click(findTestObject('ProgramManager/AddNewFormPage/div__onlynum'))

WebUI.setText(findTestObject('ProgramManager/AddNewFormPage/div__basicname'), '12345678')
