...
WebUI.click(findTestObject('ProgramManager/AddNewFormPage/div__email'))

WebUI.setText(findTestObject('ProgramManager/AddNewFormPage/div__basicname'), 'testPM01@gmail.com')
