...
def h = WebUI.getElementHeight(findTestObject('ProgramManager/HomePage/div__endedlist'))
...
WebUI.verifyElementPresent(findTestObject('ProgramManager/UnstartedProjectPage/div_programBox'), 0)
