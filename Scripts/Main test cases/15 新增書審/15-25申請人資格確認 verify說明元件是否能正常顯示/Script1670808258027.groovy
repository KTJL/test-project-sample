...
WebUI.click(findTestObject('ProgramManager/AddNewDocPage/button_CA_help'))

WebUI.verifyElementPresent(findTestObject('ProgramManager/AddNewDocPage/div_helpModal'), 0)
