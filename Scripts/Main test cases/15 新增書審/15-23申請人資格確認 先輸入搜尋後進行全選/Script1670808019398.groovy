...
WebUI.setText(findTestObject('ProgramManager/AddNewDocPage/input_search'), 'test01')

WebUI.verifyElementPresent(findTestObject('ProgramManager/AddNewDocPage/div_test01'), 0)
